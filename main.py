    """
    Dotenv Validator Pkuk0q65
    =========================
    Developer-friendly CLI that helps you deduplicate projects in seconds.
    ...
    APP_NAME    = "Dotenv Validator Pkuk0q65"
    APP_VERSION = "1.0.0"
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-friendly CLI that helps you deduplicate projects in seconds.")
